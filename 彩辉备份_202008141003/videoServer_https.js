...
var privateKey  = fs.readFileSync(__dirname + "\\Certificate" + "\\private.pem", 'utf8');
var certificate = fs.readFileSync(__dirname + "\\Certificate" + "\\file.crt", 'utf8');
...
app.post('/video/liveBroadcast', jsonParser, function (req, res) {
  ...
  deviceNumberList.forEach(element => {
var SSLPORT = 65500;
    var str = "https://" + global.configInfo.ipPublic + ":" + 65500 + "/live/"
